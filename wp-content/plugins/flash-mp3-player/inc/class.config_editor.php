...
function add_menu_item(){
    add_options_page('Flash MP3 Player -> Config Editor', 'FMP:Config Editor', 8, 'fmp_config_editor', array(&$this, 'edit_a_config_file'));
}
            ...
            <tr valign="top">
                ...
                <td>
                    ...
                    <?php foreach($this->config_array as $configfile) :?>
                        <option value="<?php echo $configfile;?>" <?php if($configfile == $this->current_config) echo 'selected="selected" ';?>><?php echo $configfile;?></option>
                    <?php endforeach;?>
                    </select>
        ...
        <table class="form-table">
            ...
            <tr valign="top">
                ...
                <td> <fieldset><legend class="hidden">Show display</legend><label for="show-display">
                            ...
                            <input id="show-display" type="checkbox" name="player-config[showdisplay]" value="true" <?php if($configs['showdisplay'] == 'true') echo ' checked="checked" ';?> />
            ...
            <tr valign="top">
                ...
                <td>
                    <fieldset><legend class="hidden">Show display</legend><label for="show-playlist">
                            ...
                            <input id="show-playlist" type="checkbox" name="player-config[showplaylist]" value="true" <?php if($configs['showplaylist'] == 'true') echo ' checked="checked" ';?> />
            ...
            <tr valign="top">
                ...
                <td>
                    <fieldset><legend class="hidden">Auto Start</legend><label for="autostart">
                            ...
                            <input id="autostart" type="checkbox" name="player-config[autostart]" value="true" <?php if($configs['autostart'] == 'true') echo ' checked="checked" ';?> />
            ...
            <tr valign="top">
                ...
                <td> <fieldset><legend class="hidden">Shuffle</legend><label for="shuffle">
                            ...
                            <input id="shuffle" type="checkbox" name="player-config[shuffle]" value="true" <?php if($configs['shuffle'] == 'true') echo ' checked="checked" ';?> />
            ...
            <tr valign="top">
                ...
                <td>
                    ...
                    <?php foreach ($repeat_option as $r_o) {
            ...
            <tr valign="top">
                ...
                <td>
                    ...
                    <?php foreach ($linktarget_option as $l_o) {
            ...
            <tr valign="top">
                ...
                <td>
                    <input type="text" id="callback" class="regular-text" name="player-config[callback]" value="<?php echo $configs['callback']; ?>" />
