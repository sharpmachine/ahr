...
function flash_mp3_player_init(){
    ...
    if (!file_exists($fmp_jw_files_dir . '/playlists/fmp_jw_widget_playlist.xml.php')){
        if (!copy($fmp_jw_dir . '/player/playlists/playlist.xml', $fmp_jw_files_dir . '/playlists/fmp_jw_widget_playlist.xml.php'))
            return;
    }

    $fmp_jw_util = new FMP_Utils();
    wp_deregister_script("swfobject");
    wp_register_script("swfobject", "http://ajax.googleapis.com/ajax/libs/swfobject/2.2/swfobject.js", array(), "2.2");
