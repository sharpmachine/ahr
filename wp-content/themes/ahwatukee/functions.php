...
register_nav_menus( array(
		'sitemap' => __( 'Site Map Navigation', 'twentyten' ),
	) );
	...
	define( 'HEADER_IMAGE_HEIGHT', apply_filters( 'twentyten_header_image_height', 610 ) );
...
function twentyten_widgets_init() {
	...
	// Testimonies.
	register_sidebar( array(
		'name' => __( 'Testimonies', 'twentyten' ),
		'id' => 'testimonies',
		'description' => __( 'Testimonies', 'twentyten' ),
		'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
		'after_widget' => '</li>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
		...
		// Featured Products.
	register_sidebar( array(
		'name' => __( 'Featured Products', 'twentyten' ),
		'id' => 'featured-products',
		'description' => __( 'Featured Products', 'twentyten' ),
		'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
		'after_widget' => '</li>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
		...
		// Bottom of Page
	register_sidebar( array(
		'name' => __( 'Bottom Message', 'twentyten' ),
		'id' => 'bottom-message',
		'description' => __( 'Bottom Message', 'twentyten' ),
		'before_widget' => '<div class="botbar">',
		'after_widget' => '</div>',
	...
	// Soaking Page
	register_sidebar( array(
		'name' => __( 'Soaking Music', 'twentyten' ),
		'id' => 'soaking-music',
		'description' => __( 'soaking-music', 'twentyten' ),
		'before_widget' => '<div>',
		'after_widget' => '</div>',
		'before_title' => '<h3 class="widget-title" style="display: none;">',
		'after_title' => '</h3>',
...
function custom_login_logo() {
  echo '<style type="text/css">
    h1 a { background-image:url('.get_bloginfo('template_directory').'/images/login-logo.png) !important; height: 202px; width: 456px; margin-left: -60px; }
    </style>';
}
...
function modify_footer_admin () {
  echo 'Created by <a href="http://redforcestudios.com">Red Force Studios</a>.';
...
function help_dashboard_widget_function() {
	...
	echo "
		...
		<ul style=width:40%;float:left;min-width:153px;>
			...
			<li><a href=http://www.youtube.com/watch?v=sZCHaX6V44A target=_blank>Overview of Site</a></li>
			<li><a href=http://www.youtube.com/watch?v=3MlUooX7uyU target=_blank>Managing Testimonies</a></li>
			<li><a href=http://www.youtube.com/watch?v=5Lz6RerkpC0 target=_blank>Managing the Widget Area</a></li>
			<li><a href=http://www.youtube.com/watch?v=1KRFsDOFan4 target=_blank>Soaking Music Player</a></li>
			<li><a href=http://www.youtube.com/watch?v=3-fzoU53Mko target=_blank>Managing Events</a></li>
		</ul>
